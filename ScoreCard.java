...
class ScoreCard {
    ...
    public static int[][] generateScores(int students) {
        ...
        for (int i = 0; i < students; i++) {
            scores[i][0] = rand.nextInt(41) + 60; // Physics (Random between 60-100)
            scores[i][1] = rand.nextInt(41) + 60; // Chemistry (Random between 60-100)
            scores[i][2] = rand.nextInt(41) + 60; // Maths (Random between 60-100)
        }
